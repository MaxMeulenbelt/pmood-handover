...
type NavProps = NativeStackScreenProps<RootStackParamList, 'RLResults'>

export default function RLResults(navProps: NavProps) {
  const { score } = navProps.route.params
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.shareButton}>{navProps.route.params && <ShareButton taskName={'Patterns and points'} value={`${score} points`} />}</View>
